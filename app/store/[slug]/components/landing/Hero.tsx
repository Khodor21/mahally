...
export default function HeroSection({
  ...
  if (loading) {
    return (
      <div className="w-full aspect-[2/1] bg-brand-grey animate-pulse rounded-xs" />
    );
  }
  ...
  return (
    <section
      dir={dir}
      className="relative w-full aspect-[2/1] rounded-xs overflow-hidden group bg-[rgb(244_242_245)]"
    >
      {/* Slides */}
