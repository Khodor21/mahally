...
export default function TestimonialsManagement({
  ...
  return (
    <div dir={dir} className="space-y-6">
      ...
      {/* Edit/Add Modal - Teleported via Portal */}
      {mounted &&
        modalOpen &&
        createPortal(
          <div
      ...
      {/* Delete Confirmation Modal - Teleported via Portal */}
      {mounted &&
        deletingId !== null &&
        createPortal(
          <div
      ...
      {toast &&
        mounted &&
        createPortal(
          <div className="fixed top-6 right-6 z-[120] bg-white border border-gray-100 shadow-xl rounded-xl p-4 animate-in fade-in slide-in-from-top-4">
